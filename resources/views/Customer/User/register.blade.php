...
<form class="form-signin" action="{{ route('customer.user.store') }}" method="post">
    @csrf
    ...
    <label  class="sr-only">{{ __('Email address') }}</label>
    ...
    <button class="btn btn-lg btn-primary btn-block" name="submit" type="submit">{{ __('Register') }}</button>

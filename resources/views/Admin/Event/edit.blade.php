    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
        ...
        @else
            <div class=" pb-2 mb-3 border-bottom">
                <h1 class="h2">{{ __('Edit Event') }} </h1>
            </div>
        @endif

        <div class="container">
            <form class="needs-validation" action="{{ route('event.update',$event->id) }}" method="post">
                @csrf
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" name="percent" value="{{ $event->percent }}" min="1"
                           max="100" required>
                </div>
                <div class="mb-3">
